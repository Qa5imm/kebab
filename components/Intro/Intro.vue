<template>
  <div class="flex flex-col items-center gap-y-10 max-sm:gap-y-6">
    <h1 id="title" class="font-bold text-4xl max-md:text-3xl max-sm:text-2xl">
      One Stop To All Your Rushes
    </h1>
    <h3
      id="headline"
